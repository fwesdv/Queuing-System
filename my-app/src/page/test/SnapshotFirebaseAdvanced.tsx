...
export class SnapshotFirebaseAdvanced extends Component {
  static propTypes = {}

  render() {
    return (
      <div>SnapshotFirebaseAdvanced</div>
    )
  }
}
...
//   const [schools, setSchools] = useState<{ id: string, title: string, desc: string, score: string, ownerEmail: string }[]>([]);
...
//   //DELETE FUNCTION
//   async function deleteSchool(school: { id: string }) {
//     try {
...
//   // EDIT FUNCTION
//   async function editSchool(school: { id: string }) {
//     const updatedSchool = {
//       score: +score,
//       lastUpdate: serverTimestamp(),
//     };
